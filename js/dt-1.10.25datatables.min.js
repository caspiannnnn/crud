...
(function (k) {
  ...
  u.ext = L = {
    ...
    classes: {},
    builder:
      "bs5/dt-1.10.25/af-2.3.7/date-1.1.0/r-2.2.9/rg-1.1.3/sc-2.0.4/sp-1.3.0",
    errMode: "alert",
    feature: [],
    search: [],
    ...
    k = function (a, b) {
      this instanceof k
        ? (b === q && (b = {}),
          ...
          (this.s = e.extend(this.s, k.oDefaults, b)),
  ...
  e.extend(k.prototype, {
    measure: function (a) {
      ...
      var c = this.dom.label.outerHeight(),
        d = this.dom.scroller.offsetHeight - this.dom.scroller.clientHeight;
      b.labelHeight = c;
    ...
    _calcRowHeight: function () {
      ...
      else for (; 3 > g; g++) d.append("<tr><td>&#160;</td></tr>");
      ...
      if (this.s.dt.oFeatures.bInfo) {
        ...
        l =
          ...
          a.fnRecordsDisplay() == a.fnRecordsTotal()
            ...
            ? b.sInfoEmpty +
              " " +
              b.sInfoFiltered.replace("_MAX_", r) +
              b.sInfoPostFix
            : a.fnRecordsDisplay() == a.fnRecordsTotal()
            ? b.sInfo
                .replace("_START_", l)
                .replace("_END_", n)
                .replace("_MAX_", r)
                .replace("_TOTAL_", t) + b.sInfoPostFix
            : b.sInfo
                .replace("_START_", l)
                .replace("_END_", n)
                .replace("_MAX_", r)
...
(function () {
  ...
  var l,
    ...
    E = (function () {
      function n(a, b, f, c, e, d) {
        ...
        c = l('<button type="button">X</button>').addClass(
      ...
      n.prototype._setListeners = function () {
        ...
        this.s.dt.on("stateSaveParams.dtsp", function (c, e, d) {
          if (l.isEmptyObject(d)) a.s.dtPane.state.clear();
            ...
            for (e = 0; e < d.searchPanes.panes.length; e++)
              d.searchPanes.panes[e].id === a.s.index &&
                (d.searchPanes.panes.splice(e, 1), e--);
        ...
        if (Array.isArray(a) || a instanceof A.Api)
          ...
          "string" === typeof this.s.colOpts.orthogonal
            ? (d[a]
                ? d[a]++
                : ((d[a] = 1),
                  e.push({ display: b, filter: a, sort: f, type: c })),
              this.s.rowData.totalOptions++)
            : e.push({ display: b, filter: a, sort: f, type: c });
      };
      n.prototype._buildPane = function (a, b, f, c, e) {
        ...
        if (this.colExists) {
          ...
          if (
            (!1 === m.show || (void 0 !== m.show && !0 !== m.show)) &&
            -1 === u
          )
            return (
          ...
          if (
            ...
            if (
              !1 === this.s.displayed &&
              ((void 0 === m.show && null === m.threshold
                ? b > this.c.threshold
                : b > m.threshold) ||
                (!0 !== m.show && 1 >= q))
            ) {
            ...
            if (void 0 !== f.searchPanes.options[b])
              for (q = 0, b = f.searchPanes.options[b]; q < b.length; q++)
                (u = b[q]),
        ...
        null !== e && 0 < l(this.dom.panesContainer).has(e).length
          ? l(this.dom.container).insertAfter(e)
              ...
              columnDefs: [
                {
                  ...
                  render: function (x, C, y) {
                    ...
                    var z =
                      ((d.s.filteringActive || d.s.showFiltered) &&
                        d.c.viewTotal) ||
                      (d.c.viewTotal && d.s.forceViewTotal)
        ...
        this.customPaneSettings && this.customPaneSettings.header
          ? (e = this.customPaneSettings.header)
          : m.header
          ? (e = m.header)
          : this.colExists &&
            (e = l.fn.dataTable.versionCheck("2")
        ...
        for (c = 0; c < a.length; c++)
          if (((k = a[c]), void 0 !== k))
            for (
              q = 0, e = this.s.dtPane.rows().indexes().toArray();
              q < e.length;
              q++
            )
              (h = e[q]),
          ...
          for (var g = 0; g < a.length; g++) {
            ...
            if ("function" === typeof h.value) {
              for (var w = 0; w < b.length; w++)
                h.value.call(this.s.dt, b[w], f[0][w]) && t++;
              for (w = 0; w < c.length; w++)
                h.value.call(this.s.dt, c[w], e[0][w]) && q++;
              "function" !== typeof v && v.push(h.filter);
            }
            (!this.c.cascadePanes || (this.c.cascadePanes && 0 !== t)) &&
              d.push(this.addRow(r, v, t, q, u, m, k));
          }
          return d;
        }
      };
      ...
      n.prototype._populatePaneArray = function (a, b, f, c) {
        ...
        if ("string" === typeof e.orthogonal)
          (f = f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal)),
          ...
          c[d]
            ...
            : ((c[d] = 1),
              this._addOption(
                d,
                f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.display),
                f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.sort),
                f.oApi._fnGetCellData(f, a, this.s.index, e.orthogonal.type),
                b,
                c
              ));
          this.s.rowData.totalOptions++;
      ...
      n.prototype._search = function (a, b) {
        for (
          var f = this.s.colOpts, c = this.s.dt, e = 0, d = this.selections;
          e < d.length;
          e++
        ) {
          var g = d[e];
      ...
      n.prototype._searchExtras = function () {
        ...
        var b = this.s.dtPane
          ...
          c = l(this.s.dtPane.table().container());
        -1 < f && (b[f] = "");
        0 < b.length
    ...
    F = (function () {
      function n(a, b, f) {
        ...
        this.dom = {
          ...
          container: p("<div/>")
            ...
            .text(e.i18n("searchPanes.loadMessage", this.c.i18n.loadMessage)),
        ...
        if (void 0 === e.settings()[0]._searchPanes) {
            ...
            e.on("preXhr.dt", function (d, g, h) {
              ...
              for (g = c.s.selectionList; d < g.length; d++) {
                ...
                for (var r = 0; r < m.rows.length; r++)
                  (h.searchPanes[k][r] = m.rows[r].filter),
          ...
          e.on("xhr", function (d, g, h, m) {
            h &&
              ...
              ((c.s.serverData = h),
              (c.s.serverData.tableLength = h.recordsTotal),
              c._serverTotals());
          });
          e.settings()[0]._searchPanes = this;
          this.dom.clearAll.text(
            e.i18n("searchPanes.clearMessage", this.c.i18n.clearMessage)
          );
          if (this.s.dt.settings()[0]._bInitComplete || f)
            this._paneDeclare(e, a, b);
          else
            e.one("preInit.dt", function (d) {
        ...
        for (var c = 0, e = this.s.panes; c < e.length; c++) {
          ...
          if (!1 === a || d.s.index === a)
            d.clearData(),
              ...
              p(this.dom.panes).append(d.dom.container);
        }
        this.c.cascadePanes || this.c.viewTotal
          ? this.redrawPanes(!0)
      ...
      n.prototype.redrawPanes = function (a) {
        ...
        if (!this.s.updating && !this.s.dt.page.info().serverSide) {
          for (
            ...
            var h = g[d];
            void 0 !== h.s.dtPane &&
              (e += h.s.dtPane.rows({ selected: !0 }).data().toArray().length);
          }
          if (
            0 === e &&
          ...
          if (this.regenerating) {
            ...
            if (0 < this.s.selectionList.length)
              for (
                ...
                (h = k[m]), (h.s.lastSelect = h.s.index === b);
            for (h = 0; h < this.s.selectionList.length; h++)
              if (
                ...
                b = !1;
                for (m = h + 1; m < this.s.selectionList.length; m++)
                  this.s.selectionList[m].index ===
                    this.s.selectionList[h].index && (b = !0);
                b ||
                  (d.push(this.s.selectionList[h]),
            ...
            if (0 < d.length && (d.length < this.s.selectionList.length || a))
              for (
                ...
                (h = a[c]), (h.s.lastSelect = h.s.index === b);
            else if (0 < d.length)
              for (h = 0, a = this.s.panes; h < a.length; h++)
                if (((d = a[h]), void 0 !== d.s.dtPane)) {
                  ...
                  if (
                    (-1 !== c && null !== c && c === d.s.index) ||
                    !1 === f ||
                    d.s.index === b
                  )
                    (g = !1), (d.s.filteringActive = !1);
                  d.updatePane(g ? f : g);
                }
          }
      ...
      n.prototype.resizePanes = function () {
        if ("auto" === this.c.layout) {
          ...
          for (e = this.s.panes; b < e.length; b++)
            (g = e[b]),
              g.s.displayed &&
                ((d = "columns-" + (-1 === c.indexOf(g.s.index) ? a : f)),
                g.resize(d));
        } else
          for (a = 0, f = this.s.panes; a < f.length; a++)
            (g = f[a]), g.adjustTopRow();
        return this;
      };
      n.prototype._attach = function () {
        ...
        for (var b = 0, f = this.s.panes; b < f.length; b++)
          p(f[b].dom.container).appendTo(this.dom.panes);
      ...
      n.prototype._cascadeRegen = function (a, b) {
        this.regenerating = !0;
        var f = -1;
        ...
        for (var c = 0, e = this.s.panes; c < e.length; c++)
          (b = e[c]),
            b.setCascadeRegen(!0),
            b.setClear(!0),
            ((void 0 !== b.s.dtPane && b.s.index === f) ||
              void 0 !== b.s.dtPane) &&
              b.clearPane(),
            b.setClear(!1);
        this.s.dt.draw();
        f = this.s.dt.rows({ search: "applied" }).data().toArray().length;
        c = this.s.dt.rows().data().toArray().length;
        if (c !== f) {
          e = 0;
          for (var d = this.s.panes; e < d.length; e++)
            (b = d[e]), (b.s.forceViewTotal = !0);
        }
        e = 0;
        for (d = this.s.panes; e < d.length; e++) (b = d[e]), b.updatePane(!0);
        this._makeCascadeSelections(a);
        this.s.selectionList = a;
        a = 0;
        for (e = this.s.panes; a < e.length; a++)
          (b = e[a]), b.setCascadeRegen(!1);
        this.regenerating = !1;
        if (c !== f)
          for (a = 0, f = this.s.panes; a < f.length; a++)
            (b = f[a]), (b.s.forceViewTotal = !1);
      };
      ...
      n.prototype._paneDeclare = function (a, b, f) {
        ...
        a.columns(0 < this.c.columns.length ? this.c.columns : void 0)
          .eq(0)
          .each(function (h) {
            c.s.panes.push(new E(b, f, h, c.c.layout, c.dom.panes));
          });
        for (
          var e = a.columns().eq(0).toArray().length,
            d = this.c.panes.length,
            g = 0;
          g < d;
          g++
        )
          this.s.panes.push(
            new E(b, f, e + g, this.c.layout, this.dom.panes, this.c.panes[g])
          );
        if (0 < this.c.order.length)
          for (
            e = this.c.order.map(function (h, m, k) {
            ...
            this.dom.panes.append(d[e].dom.container);
      ...
      n.prototype._serverTotals = function () {
        for (
          var a = !1, b = !1, f = this.s.dt, c = 0, e = this.s.panes;
          c < e.length;
          c++
        ) {
          var d = e[c];
          ...
          for (c = 0; c < this.s.selectionList.length; c++) {
            ...
            if (!d) {
              ...
              for (var g = this.s.panes; a < g.length; a++)
                (d = g[a]),
                  d.s.index === this.s.selectionList[c].index &&
                    0 <
        ...
        if (b && 1 === this.s.selectionList.length)
          for (b = 0, c = this.s.panes; b < c.length; b++)
            (d = c[b]),
              (d.s.lastSelect = !1),
              (d.s.deselect = !1),
              void 0 !== d.s.dtPane &&
          ...
          for (
            ...
            (d = e[c]), (d.s.lastSelect = d.s.index === b), (d.s.deselect = !1);
        else if (0 === this.s.selectionList.length)
          for (b = 0, c = this.s.panes; b < c.length; b++)
            (d = c[b]), (d.s.lastSelect = !1), (d.s.deselect = !1);
        ...
        for (c = this.s.panes; b < c.length; b++)
          (d = c[b]),
            ...
            p(this.dom.panes).append(d.dom.container),
            void 0 !== d.s.dtPane &&
              ((p(d.s.dtPane.table().node()).parent()[0].scrollTop =
                d.s.scrollTop),
              p.fn.dataTable.select.init(d.s.dtPane));
        this._updateSelection();
      };
      n.prototype._startup = function (a) {
        ...
        this.s.stateRead ||
          null === f ||
          void 0 === f ||
          (this.s.dt.page(f.start / this.s.dt.page.len()),
          this.s.dt.draw("page"));
        this.s.stateRead = !0;
        ...
        if (this.s.dt.page.info().serverSide)
          a.off("page"),
            ...
            a.off("preXhr.dt"),
            a.on("preXhr.dt", function (h, m, k) {
              void 0 === k.searchPanes && (k.searchPanes = {});
              void 0 === k.searchPanes_null && (k.searchPanes_null = {});
              m = h = 0;
              for (var r = b.s.panes; m < r.length; m++) {
                var v = r[m],
        ...
        for (c = this.s.panes; f < c.length; f++)
          if (
            ...
            for (d = 0; d < e; d++)
              (-1 !==
                g.s.colOpts.preSelect.indexOf(g.s.dtPane.cell(d, 0).data()) ||
                (null !== g.customPaneSettings &&
                  void 0 !== g.customPaneSettings.preSelect &&
                  -1 !==
                    g.customPaneSettings.preSelect.indexOf(
                      g.s.dtPane.cell(d, 0).data()
                    ))) &&
                g.s.dtPane.row(d).select();
            g.updateTable();
          }
        if (void 0 !== this.s.selectionList && 0 < this.s.selectionList.length)
          for (
            f = this.s.selectionList[this.s.selectionList.length - 1].index,
              c = 0,
              e = this.s.panes;
            c < e.length;
            c++
          )
            (g = e[c]), (g.s.lastSelect = g.s.index === f);
      ...
      n.prototype._prepViewTotal = function (a) {
        for (
          var b = this.s.filterPane, f = !1, c = 0, e = this.s.panes;
          c < e.length;
          c++
        ) {
          var d = e[c];
          if (void 0 !== d.s.dtPane) {
            var g = d.s.dtPane.rows({ selected: !0 }).data().toArray().length;
            0 < g && -1 === b
              ? ((b = d.s.index), (f = !0))
              : 0 < g && (b = null);
          }
        ...
        for (c = this.s.panes; a < c.length; a++)
          if (
            ...
            void 0 !== d.s.dtPane &&
              ((d.s.filteringActive = !0),
              (-1 !== b && null !== b && b === d.s.index) || !1 === f))
          )
            d.s.filteringActive = !1;
      };
  ...
  (function (n) {
    ...
    n.fn.dataTable.ext.buttons.searchPanes = {
      ...
      config: {},
      init: function (e, d, g) {
        var h = new n.fn.dataTable.SearchPanes(
            e,
            n.extend(
              {
                filterChanged: function (k) {
                  e.button(d).text(
                    e.i18n("searchPanes.collapse", h.c.i18n.collapse, k)
                  );
                },
              },
              g.config
    ...
    n(b).on("preInit.dt.dtsp", function (e, d, g) {
      "dt" === e.namespace &&
        (d.oInit.searchPanes || c.defaults.searchPanes) &&
        (d._searchPanes || f(d, null, !0));
    });
